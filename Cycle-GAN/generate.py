...
parser.add_argument("--save", default="cycleGan/NR_train", type=str, help="savepath, Default: results")
parser.add_argument("--ori", default="cycleGan/NR_train", type=str, help="savepath, Default: results")
parser.add_argument("--gpus", default="0", type=str, help="gpu ids")
parser.add_argument("--root", default="dataset/preprocessed/ALLDATA", type=str)
