...
parser.add_argument("--model", default="cycleGan/Experiment/exp_full/checkpoint/model_denoise_200_30.pth", type=str, help="model path")
parser.add_argument("--save", default="cycleGan/deg", type=str, help="savepath, Default: results")
parser.add_argument("--gpus", default="0", type=str, help="gpu ids")
parser.add_argument("--dataset", default='dataset/EyeQ_degraded/pre',type=str,)
