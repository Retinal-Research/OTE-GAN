...
class SAM(nn.Module):
    ...
    def forward(self, x, x_img):
        ...
        x1 = x1*x2
        x1 = x1+x
        return x1, torch.clamp(img,min=0.0,max=1.0)
...
#                 if normalize:
#                     layers.append(nn.LayerNorm([out_filters,512/step,512/step]))
...
#             *discriminator_block(256, 256,step=64),
#             *discriminator_block(256, 512,step=128),
#             *discriminator_block(512, 512,step=128),
#             *discriminator_block(512, 1024,step=128),
#             #*discriminator_block(1024, 2048,step=128),
