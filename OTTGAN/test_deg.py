...
parser.add_argument("--model", default="OttGam/Experiment/exp_full/checkpoint/model_denoise_200_30.pth", type=str, help="model path")
parser.add_argument("--save", default="OttGam/deg_idrid_test", type=str, help="savepath, Default: results")
parser.add_argument("--gpus", default="0", type=str, help="gpu ids")
parser.add_argument("--dataset", default='dataset/segmentation/NewIDRID/test/images',type=str)
