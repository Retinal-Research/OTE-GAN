...
parser.add_argument("--model", default="OttGam/Experiment/exp1/checkpoint/model_denoise_200_50.pth", type=str, help="model path")
#parser.add_argument("--model", default="OttGam/Experiment/exp2/checkpoint/model_denoise_163_50.pth", type=str, help="model path")
# parser.add_argument("--save", default="OttGam/NR_result", type=str, help="savepath, Default: results")
# parser.add_argument("--ori", default="OttGam/NR_result", type=str, help="savepath, Default: results")
...
parser.add_argument("--save", default="OttGam/NR_train", type=str, help="savepath, Default: results")
parser.add_argument("--ori", default="OttGam/NR_train", type=str, help="savepath, Default: results")
parser.add_argument("--gpus", default="0", type=str, help="gpu ids")
parser.add_argument("--root", default="dataset/preprocessed/ALLDATA", type=str)
